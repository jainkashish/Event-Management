...
public class GridViewAdapter extends BaseAdapter implements Filterable
{
	...
	public GridViewAdapter(Activity context, ArrayList<String> content , ArrayList<Integer> catogryImages) 
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		rowView = inflater.inflate(R.layout.guest_item, null);
		ImageView btnIcon=(ImageView)rowView.findViewById(R.id.icon);
		TextView txtName = (TextView) rowView.findViewById(R.id.product_name);
